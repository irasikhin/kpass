...
func (cmd *EditCmd) Run(c *ctx) error {
	directChanges := cmd.Rename != nil || cmd.Username != nil || cmd.URL != nil ||
		cmd.Notes != nil || cmd.OTP != nil || len(cmd.Tags) > 0 || len(cmd.Clear) > 0 || len(cmd.Field) > 0 || cmd.Password.touched()
